  ...
  <section class="dc_hero">
    ...
    <div class="dc_hero_body">
      <div class="dc_hero_logo">
        <img src="/winwii/v10/logo.webp" alt="${r}" loading="lazy">
      </div>
