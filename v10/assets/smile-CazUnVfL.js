import{j as s}from"./vendor-gzd0YkcT.js";import{auth as _,db as u}from"./firebase-DOPXtL1R.js";import{o as x,q as S,w as k,c as D,s as j,d as b,b as M,a as N}from"./firebase-D7N42Z9V.js";import{N as c,c as q,a as A,S as I,d,g as T}from"./main-CYX6JOAB.js";import"./main-DTOxB6dq.js";let o=[],m=null,r=null;const C="wi_notas_cache",p=()=>T("wiSmile")||{},H=a=>{try{localStorage.setItem(C,JSON.stringify(a))}catch{}},E=()=>{try{return JSON.parse(localStorage.getItem(C)||"[]")}catch{return[]}},z=()=>{const{nombre:a="",usuario:t="",email:e=""}=p(),i=a||t||e||_.currentUser?.email||"";return`
