  ...
  <section class="ac_hero">
    ...
    <div class="ac_hero_body">
      <div class="ac_hero_logo">
        <img src="/winwii/v12/logo.webp" alt="${o}" loading="lazy">
      </div>
...
</div>`,C=()=>{c(".ac_counter_num").each(function(){const a=c(this),s=+a.data("target"),i=1800;let n=null;const r=l=>{n||(n=l);const t=Math.min((l-n)/i,1),m=1-Math.pow(1-t,3);a.text(Math.floor(m*s).toLocaleString()),t<1&&requestAnimationFrame(r)};requestAnimationFrame(r)})},z=()=>{e(".ac_modulo_card",null,{anim:"wi_fadeUp",stagger:60}),e(".ac_feat_card",null,{anim:"wi_fadeUp",stagger:80}),e(".ac_paso",null,{anim:"wi_fadeUp",stagger:120}),e(".ac_mv_card",null,{anim:"wi_fadeUp",stagger:100}),e(".ac_tech_item",null,{anim:"wi_fadeUp",stagger:60}),e(".ac_test_card",null,{anim:"wi_fadeUp",stagger:80}),e(".ac_cta_wrap",null,{anim:"wi_fadeUp"});const a=c(".ac_counter_band")[0];if(a){const s=new IntersectionObserver(([i])=>{i.isIntersecting&&(C(),s.disconnect())},{threshold:.3});s.observe(a)}c("#ac_compartir").on("click",function(){const s="https://winwii.web.app/";navigator.share?navigator.share({title:o,text:`📅 ${o} — Planificador Semanal Profesional`,url:s}).catch(()=>{}):g(s,this,"¡Link copiado! ✨")}),console.log(`📖 ${o} ${p} · Acerca ${u()}`)},T=()=>{c("#ac_compartir").off("click"),console.log("🧹 Acerca")};export{T as cleanup,z as init,M as render};
