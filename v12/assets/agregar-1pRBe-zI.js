import{j as i}from"./vendor-gzd0YkcT.js";import{auth as y,db as u}from"./firebase-Bi8Rqrtl.js";import{e as I,c as h,a as A,d as b,q as L,w as T,g as S,b as f}from"./firebase-CrRCUYpg.js";import{N as n,i as l,g as U,d as p}from"./main-rlN7McrR.js";const e="wiAudios",d="wiImg",m=()=>U("wiSmile")?.email||y.currentUser?.email||"",g=async s=>{const t=m();if(!t)return[];const r=L(h(u,s),T("email","==",t));return(await S(r)).docs.map(c=>({id:c.id,...c.data()})).sort((c,o)=>(o.creado?.seconds||0)-(c.creado?.seconds||0))},v=async(s,t,r)=>{const a=m();return a?(await I(h(u,s),{email:a,titulo:t,src:r,creado:f(),actualizado:f()})).id:null},x=async(s,t)=>{await A(b(u,s,t))},B=()=>g(e),D=()=>g(d),C=(s,t)=>`
