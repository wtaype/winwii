import{j as c}from"./vendor-gzd0YkcT.js";import{auth as l}from"./firebase-Lfd52dYI.js";import{o as _}from"./firebase-Cdwg_wrl.js";import{a as p,g as w}from"./main-CuczXLwU.js";const f=()=>new Promise(a=>{if(l.currentUser)return a(l.currentUser);const s=_(l,i=>{s(),a(i)})}),n=a=>{if(!a)return"—";const s=a.seconds?new Date(a.seconds*1e3):new Date(a);return isNaN(s.getTime())?"—":s.toLocaleDateString("es-ES",{day:"numeric",month:"long",year:"numeric"})},u=()=>{const a=new Date().getHours();return a<12?{txt:"Buenos días",ico:"fa-sun"}:a<18?{txt:"Buenas tardes",ico:"fa-cloud-sun"}:{txt:"Buenas noches",ico:"fa-moon"}},x=()=>`
  <div class="smw_page">
