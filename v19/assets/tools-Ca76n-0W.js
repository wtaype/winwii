import{j as a}from"./vendor-gzd0YkcT.js";import{a as F,h as p,q as T}from"./main-CuczXLwU.js";const S=(()=>{if(typeof window>"u")return"";const l=window.location.hostname;return new Set(["localhost",T]).has(l)?`http://${l}:3000`:window.location.origin})(),O=()=>`
