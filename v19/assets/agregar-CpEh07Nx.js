import{j as i}from"./vendor-gzd0YkcT.js";import{auth as y,db as u}from"./firebase-Lfd52dYI.js";import{j as I,c as h,i as A,f as b,q as L,w as T,g as S,h as f}from"./firebase-Cdwg_wrl.js";import{h as n,m as l,g as U,c as p}from"./main-CuczXLwU.js";const e="wiAudios",g="wiImg",m=()=>U("wiSmile")?.email||y.currentUser?.email||"",d=async s=>{const t=m();if(!t)return[];const r=L(h(u,s),T("email","==",t));return(await S(r)).docs.map(c=>({id:c.id,...c.data()})).sort((c,o)=>(o.creado?.seconds||0)-(c.creado?.seconds||0))},v=async(s,t,r)=>{const a=m();return a?(await I(h(u,s),{email:a,titulo:t,src:r,creado:f(),actualizado:f()})).id:null},x=async(s,t)=>{await A(b(u,s,t))},j=()=>d(e),B=()=>d(g),C=(s,t)=>`
...
</div>`,_=(s,t)=>s.length?s.map(r=>C(r,t)).join(""):'<p class="ag_vacio"><i class="fas fa-inbox"></i> Sin elementos guardados</p>',D=()=>`
<div class="agregar">
