import{j as t}from"./vendor-gzd0YkcT.js";import{h as p,a as x,S as T,c as b,g as S}from"./main-CuczXLwU.js";const j="wii_emojis_notepad",C="wii_emojis_recientes",d={recientes:{icon:"fa-clock",label:"Recientes"},caras:{icon:"fa-smile",label:"Caras"},corazones:{icon:"fa-heart",label:"Corazones"},manos:{icon:"fa-hand-paper",label:"Manos"},animales:{icon:"fa-paw",label:"Animales"},comida:{icon:"fa-utensils",label:"Comida"},objetos:{icon:"fa-lightbulb",label:"Objetos"},simbolos:{icon:"fa-star",label:"Símbolos"},banderas:{icon:"fa-flag",label:"Banderas"}},h={caras:["😀","😃","😄","😁","😆","😅","🤣","😂","🙂","🙃","😉","😊","😇","🥰","😍","🤩","😘","😗","☺️","😚","😙","🥲","😋","😛","😜","🤪","😝","🤑","🤗","🤭","🤫","🤔","🤐","🤨","😐","😑","😶","😏","😒","🙄","😬","🤥","😌","😔","😪","🤤","😴","😷","🤒","🤕","🤢","🤮","🤧","🥵","🥶","🥴","😵","🤯","🤠","🥳","🥸","😎","🤓","🧐","😕","😟","🙁","☹️","😮","😯","😲","😳","🥺","😦","😧","😨","😰","😥","😢","😭","😱","😖","😣","😞","😓","😩","😫","🥱","😤","😡","😠","🤬","😈","👿","💀","☠️","💩","🤡","👹","👺","👻","👽","👾","🤖","😺","😸","😹","😻","😼","😽","🙀","😿","😾"],corazones:["❤️","🧡","💛","💚","💙","💜","🖤","🤍","🤎","💔","❣️","💕","💞","💓","💗","💖","💘","💝","💟","♥️","🫀","❤️‍🔥","❤️‍🩹","🩷","🩵","🩶","💌","💋","👄","🫦","💑","👩‍❤️‍👨","👨‍❤️‍👨","👩‍❤️‍👩","💏","👩‍❤️‍💋‍👨","👨‍❤️‍💋‍👨","👩‍❤️‍💋‍👩","🥰","😍","😘","😻","💐","🌹","🥀","🌷","🌸","💮"],manos:["👋","🤚","🖐️","✋","🖖","👌","🤌","🤏","✌️","🤞","🤟","🤘","🤙","👈","👉","👆","🖕","👇","☝️","👍","👎","✊","👊","🤛","🤜","👏","🙌","👐","🤲","🤝","🙏","✍️","💅","🤳","💪","🦾","🦿","🦵","🦶","👂","🦻","👃","🧠","🫀","🫁","🦷","🦴","👀","👁️","👅","👄","🫦","💋","👶","🧒","👦","👧","🧑","👱","👨","🧔","👩","🧓","👴","👵"],animales:["🐶","🐱","🐭","🐹","🐰","🦊","🐻","🐼","🐻‍❄️","🐨","🐯","🦁","🐮","🐷","🐽","🐸","🐵","🙈","🙉","🙊","🐒","🐔","🐧","🐦","🐤","🐣","🐥","🦆","🦅","🦉","🦇","🐺","🐗","🐴","🦄","🐝","🪱","🐛","🦋","🐌","🐞","🐜","🪰","🪲","🪳","🦟","🦗","🕷️","🦂","🐢","🐍","🦎","🦖","🦕","🐙","🦑","🦐","🦞","🦀","🐡","🐠","🐟","🐬","🐳","🐋","🦈","🐊","🐅","🐆","🦓","🦍","🦧","🦣","🐘","🦛","🦏","🐪","🐫","🦒","🦘"],comida:["🍏","🍎","🍐","🍊","🍋","🍌","🍉","🍇","🍓","🫐","🍈","🍒","🍑","🥭","🍍","🥥","🥝","🍅","🍆","🥑","🥦","🥬","🥒","🌶️","🫑","🌽","🥕","🫒","🧄","🧅","🥔","🍠","🥐","🥯","🍞","🥖","🥨","🧀","🥚","🍳","🧈","🥞","🧇","🥓","🥩","🍗","🍖","🦴","🌭","🍔","🍟","🍕","🫓","🥪","🥙","🧆","🌮","🌯","🫔","🥗","🥘","🫕","🍝","🍜","🍲","🍛","🍣","🍱","🥟","🦪","🍤","🍙","🍚","🍘","🍥","🥠","🥮","🍢","🍡","🍧","🍨","🍦","🥧","🧁","🍰","🎂","🍮","🍭","🍬","🍫","🍿","🍩","🍪","🌰","🥜","🍯"],objetos:["📱","💻","⌨️","🖥️","🖨️","🖱️","🖲️","💽","💾","💿","📀","📼","📷","📸","📹","🎥","📽️","🎞️","📞","☎️","📟","📠","📺","📻","🎙️","🎚️","🎛️","🧭","⏱️","⏲️","⏰","🕰️","⌛","⏳","📡","🔋","🔌","💡","🔦","🕯️","🧯","🛢️","💸","💵","💴","💶","💷","🪙","💰","💳","💎","⚖️","🪜","🧰","🪛","🔧","🔨","⚒️","🛠️","⛏️","🪚","🔩","⚙️","🪤","🧱","⛓️","🧲","🔫","💣","🧨","🪓","🔪","🗡️","⚔️","🛡️","🚬","⚰️","🪦","⚱️","🏺"],simbolos:["⭐","🌟","✨","💫","⚡","🔥","💥","☀️","🌙","🌈","☁️","❄️","💧","🌊","🎯","🏆","🥇","🥈","🥉","🏅","🎖️","🎗️","🎪","🎭","🎨","🎬","🎤","🎧","🎼","🎹","🥁","🎷","🎺","🎸","🪕","🎻","🎲","♟️","🎯","🎳","🎮","🕹️","🎰","🧩","♠️","♥️","♦️","♣️","🃏","🀄","🎴","🔮","✅","❌","❓","❗","💯","🔴","🟠","🟡","🟢","🔵","🟣","⚫","⚪","🟤","🔶","🔷","🔸","🔹","🔺","🔻","💠","🔘","🔳","🔲","▪️","▫️","◾","◽"],banderas:["🏳️","🏴","🏁","🚩","🏳️‍🌈","🏳️‍⚧️","🇦🇷","🇧🇴","🇧🇷","🇨🇱","🇨🇴","🇨🇷","🇨🇺","🇩🇴","🇪🇨","🇸🇻","🇬🇹","🇭🇳","🇲🇽","🇳🇮","🇵🇦","🇵🇾","🇵🇪","🇵🇷","🇺🇾","🇻🇪","🇪🇸","🇺🇸","🇬🇧","🇫🇷","🇩🇪","🇮🇹","🇵🇹","🇯🇵","🇰🇷","🇨🇳","🇮🇳","🇷🇺","🇦🇺","🇨🇦","🇳🇱","🇧🇪","🇨🇭","🇦🇹","🇸🇪","🇳🇴","🇩🇰","🇫🇮"]};let r="caras",c=[];const E=()=>S("wiSmile")||{},_=()=>{try{return JSON.parse(localStorage.getItem(C)||"[]")}catch{return[]}},$=a=>{localStorage.setItem(C,JSON.stringify(a.slice(0,32)))},y=a=>{c=_(),c=c.filter(s=>s!==a),c.unshift(a),c=c.slice(0,32),$(c)},w=()=>localStorage.getItem(j)||"",u=a=>localStorage.setItem(j,a),g=async a=>{try{return await navigator.clipboard.writeText(a),!0}catch{const s=document.createElement("textarea");return s.value=a,s.style.position="fixed",s.style.opacity="0",document.body.appendChild(s),s.select(),document.execCommand("copy"),document.body.removeChild(s),!0}},v=(a="")=>{let s=[];r==="recientes"?s=_():s=h[r]||[],a&&(s=Object.values(h).flat().filter(o=>o.includes(a)));const n=t(".em_grid");if(s.length===0){n.html('<div class="em_empty">No hay emojis</div>');return}n.html(s.map(e=>`
    <button class="em_emoji" data-emoji="${e}" ${b("Click para copiar")}>
      ${e}
    </button>
  `).join(""))},O=()=>{const a=E(),s=a.nombre||a.usuario||a.email||"";return c=_(),`
