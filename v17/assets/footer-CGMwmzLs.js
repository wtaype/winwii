import{j as a}from"./vendor-gzd0YkcT.js";import{l as e,b as n,n as t,a as s,v}from"./main-C2_vhC0w.js";function r(){const o=new Date;return`
  ...
  `}a("body").append(r());a("head").append('<style>:root{--bgim:url("/winwii/v17/wpuntos.svg")}body{background: var(--bgim), var(--bg)}</style>');const i=()=>`<div class="movil_divider"></div>${a(".nv_right").html()}`;a("body").append(`<div class="movil_overlay"></div>
