import{j as i}from"./vendor-gzd0YkcT.js";import{auth as y,db as u}from"./firebase-DHVsH4U5.js";import{e as I,c as h,a as A,d as b,q as L,w as T,g as S,b as f}from"./firebase-Whrs9NU2.js";import{N as n,j as l,g as U,d as p}from"./main-B6nsIEdO.js";const e="wiAudios",d="wiImg",m=()=>U("wiSmile")?.email||y.currentUser?.email||"",g=async s=>{const t=m();if(!t)return[];const r=L(h(u,s),T("email","==",t));return(await S(r)).docs.map(c=>({id:c.id,...c.data()})).sort((c,o)=>(o.creado?.seconds||0)-(c.creado?.seconds||0))},v=async(s,t,r)=>{const a=m();return a?(await I(h(u,s),{email:a,titulo:t,src:r,creado:f(),actualizado:f()})).id:null},x=async(s,t)=>{await A(b(u,s,t))},j=()=>g(e),B=()=>g(d),C=(s,t)=>`
