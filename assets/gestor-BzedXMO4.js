const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-CEDqlAXn.js","assets/vendor-gzd0YkcT.js"])))=>i.map(i=>d[i]);
import{g as r,s as p,_ as P,N as M,d as x,S as R,C as D,a as F,f as K,e as O}from"./main-CEDqlAXn.js";import{j as e}from"./vendor-gzd0YkcT.js";import{db as _}from"./firebase-BbiX5iLQ.js";import{q as g,l as w,w as u,c as f,a as V,g as m,b as A}from"./firebase-Cdwg_wrl.js";const T=()=>r("wiSmile"),$="gsTotalAlumnos",y="gsTotalClases",C="gsFeedReciente",k="gsMetricas",b={feedSub:null},B=async()=>{const a=T();if(!a)return`
    <div class="gs_page">
