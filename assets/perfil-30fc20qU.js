import{j as i}from"./vendor-gzd0YkcT.js";import{db as d}from"./firebase-a1Ov4hWR.js";import{n as u,d as _}from"./firebase-Whrs9NU2.js";import{r as m,d as c,s as v,M as e,c as b,g as h}from"./main-ChOd9MzQ.js";const l=()=>h("wiSmile")||{},D=()=>{const a=l();if(!a.email)return location.replace("/"),"";const s=a.nombre||"",r=a.apellidos||"",p=a.usuario||"",f=a.email||"",o=a.rol||"smile",n=a.uid||"",t=a.imagen||"./smile.avif";return((s[0]||"")+(r[0]||"")).toUpperCase(),`
  <div class="prf_wrap">
