import{j as s}from"./vendor-gzd0YkcT.js";import{auth as k,db as m}from"./firebase-D3LCa7rv.js";import{b,d as p,e as C,k as I,q as F,c as O,w as L,l as j,a as A}from"./firebase-DYzFYKGm.js";import{r as P,a as q,S as B,d as f,g as U,N as w}from"./main-D1Fv2rJO.js";let o=[],u=null,g=null,h=null;const $="wi_notas_cache",E="wi_notas_cache_time",H=100,M=1200,z=300*1e3,x=()=>U("wiSmile")||{},l=n=>{try{localStorage.setItem($,JSON.stringify(n)),localStorage.setItem(E,Date.now().toString())}catch{}},S=()=>{try{return JSON.parse(localStorage.getItem($)||"[]")}catch{return[]}},G=()=>{const n=parseInt(localStorage.getItem(E)||"0");return Date.now()-n<z},V=()=>{localStorage.removeItem($),localStorage.removeItem(E)},y=[{id:"Cielo",hex:"#0EBEFF",bg:"rgba(14,190,255,.12)",tx:"var(--tx)",rgb:"14,190,255"},{id:"Dulce",hex:"#FF5C93",bg:"rgba(255,92,147,.12)",tx:"var(--tx)",rgb:"255,92,147"},{id:"Paz",hex:"#10B981",bg:"rgba(16,185,129,.12)",tx:"var(--tx)",rgb:"16,185,129"},{id:"Mora",hex:"#8B5CF6",bg:"rgba(139,92,246,.12)",tx:"var(--tx)",rgb:"139,92,246"},{id:"Sol",hex:"#F59E0B",bg:"rgba(245,158,11,.12)",tx:"var(--tx)",rgb:"245,158,11"}],ra=()=>{const n=x();if(!n.email)return location.replace("/"),"";const a=n.nombre||n.usuario||n.email||k.currentUser?.email||"";return`
