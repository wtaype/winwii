import{j as a}from"./vendor-gzd0YkcT.js";import{a as F,j as p,u as T}from"./main-Dlu14CdS.js";const S=(()=>{if(typeof window>"u")return"";const l=window.location.hostname;return new Set(["localhost",T]).has(l)?`http://${l}:3000`:window.location.origin})(),O=()=>`
