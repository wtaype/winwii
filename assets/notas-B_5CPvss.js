import{j as s}from"./vendor-gzd0YkcT.js";import{auth as k,db as m}from"./firebase-Df8XmDw5.js";import{s as C,d as p,b,a as F,q as I,c as O,w as L,m as j,g as A}from"./firebase-Whrs9NU2.js";import{r as P,a as q,S as U,d as f,g as H,N as w}from"./main-B7BjZQg_.js";let o=[],u=null,g=null,h=null;const $="wi_notas_cache",E="wi_notas_cache_time",M=100,z=1200,B=300*1e3,x=()=>H("wiSmile")||{},l=n=>{try{localStorage.setItem($,JSON.stringify(n)),localStorage.setItem(E,Date.now().toString())}catch{}},S=()=>{try{return JSON.parse(localStorage.getItem($)||"[]")}catch{return[]}},G=()=>{const n=parseInt(localStorage.getItem(E)||"0");return Date.now()-n<B},V=()=>{localStorage.removeItem($),localStorage.removeItem(E)},y=[{id:"Cielo",hex:"#0EBEFF",bg:"rgba(14,190,255,.15)",tx:"var(--tx)"},{id:"Dulce",hex:"#FF5C69",bg:"rgba(255,92,105,.15)",tx:"var(--tx)"},{id:"Paz",hex:"#29C72E",bg:"rgba(41,199,46,.15)",tx:"var(--tx)"},{id:"Mora",hex:"#7000FF",bg:"rgba(112,0,255,.15)",tx:"var(--tx)"},{id:"Futuro",hex:"#21273B",bg:"rgba(33,39,59,.25)",tx:"var(--tx)"}],ra=()=>{const n=x();if(!n.email)return location.replace("/"),"";const a=n.nombre||n.usuario||n.email||k.currentUser?.email||"";return`
