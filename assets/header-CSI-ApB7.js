const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/login-DfwV9xUz.js","assets/vendor-gzd0YkcT.js","assets/firebase-BP87Sbwy.js","assets/main-BbS6aP-L.js","assets/firebase-CrRCUYpg.js","assets/login-pzxUIRzl.css"])))=>i.map(i=>d[i]);
import{M as l,e as n,r as c,_ as e}from"./main-BbS6aP-L.js";import{j as s}from"./vendor-gzd0YkcT.js";const r=a=>{l?.("Bienvenido "+a.nombre),s(".nv_right").html(`
  ...
  `)};n.on(a=>a?r(a):(o(),c.navigate("/")));const t=n.user;t?r(t):o();const p=["wiTema","wiSmart","wiFresh"];s(document).on("click",".bt_salir",async()=>{const{salir:a}=await e(async()=>{const{salir:i}=await import("./login-DfwV9xUz.js");return{salir:i}},__vite__mapDeps([0,1,2,3,4,5]));a(p)});s(document).on("click",".bt_auth",async function(){const{abrirLogin:a}=await e(async()=>{const{abrirLogin:i}=await import("./login-DfwV9xUz.js");return{abrirLogin:i}},__vite__mapDeps([0,1,2,3,4,5]));a(s(this).hasClass("registrar")?"registrar":"login")});export{r as personal};
