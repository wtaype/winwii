import{j as e}from"./vendor-gzd0YkcT.js";import{a as z,N as l,i as L}from"./main-B7BjZQg_.js";const g=(()=>{if(typeof window>"u")return"";const d=window.location.hostname;return new Set(["localhost",L]).has(d)?`http://${d}:3000`:window.location.origin})(),M=()=>`
