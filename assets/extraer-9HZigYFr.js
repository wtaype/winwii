import{j as e}from"./vendor-gzd0YkcT.js";import{a as z,N as l,k as L}from"./main-DGj1lpKw.js";const g=(()=>{if(typeof window>"u")return"";const d=window.location.hostname;return new Set(["localhost",L]).has(d)?`http://${d}:3000`:window.location.origin})(),M=()=>`
