...
</div>`,P=()=>{let a=0;const s=t(".ini_role");setInterval(()=>{s.removeClass("active"),s.eq(a=(a+1)%s.length).addClass("active")},2800),n("#in_stats",()=>{t(".ini_stat_n").each(function(){const e=t(this),o=+e.data("target"),p=e.data("sufijo")||"";let c=0;const _=setInterval(()=>{c+=o/50,c>=o?(e.text(o+p),clearInterval(_)):e.text(Math.floor(c))},28)})}),n(".ini_cat_card",null,{anim:"wi_fadeUp",stagger:80}),n(".ini_about_card",null,{anim:"wi_fadeUp",stagger:140}),n(".ini_cta_wrap",null,{anim:"wi_fadeUp"}),console.log(`📅 ${d} ${r} · Inicio OK`)},z=()=>console.log("🧹 Inicio limpiado");export{z as cleanup,P as init,D as render};
