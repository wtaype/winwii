const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-Dlu14CdS.js","assets/vendor-gzd0YkcT.js"])))=>i.map(i=>d[i]);
import{g as r,s as p,_ as C,N as M,i as T,S as R,C as D,a as F,f as K,h as O}from"./main-Dlu14CdS.js";import{j as e}from"./vendor-gzd0YkcT.js";import{db as _}from"./firebase-C4LyfHx4.js";import{q as g,l as w,w as u,c as f,a as V,g as m,b as P}from"./firebase-CiLZDPlJ.js";const x=()=>r("wiSmile"),$="gsTotalAlumnos",y="gsTotalClases",A="gsFeedReciente",k="gsMetricas",b={feedSub:null},B=async()=>{const a=x();if(!a)return`
    <div class="gs_page">
      <div class="gs_empty"><i class="fas fa-lock"></i><p>Sin sesión activa.</p></div>
    </div>`;const o=M(a.nombres||a.nombre||"Instructor"),s=T(a.nombres||a.nombre||""),t=a.foto||null,i=r($)??"—",l=r(y)??"—",n=r(k)||{},v=[{page:"misclases",ico:"fa-chalkboard-teacher",color:"#6366f1",title:"Aulas",sub:"Crea y gestiona tus clases"},{page:"alumnos",ico:"fa-users",color:"#0ea5e9",title:"Estudiantes",sub:"Métricas y asignaciones"},{page:"calificaciones",ico:"fa-chart-bar",color:"#f59e0b",title:"Rankings",sub:"Podio de rendimiento"},{page:"buscar",ico:"fa-search",color:"#22c55e",title:"Búsqueda",sub:"Historial detallado"},{page:"mensajes",ico:"fa-paper-plane",color:"#ec4899",title:"Notificaciones",sub:"Comunicados oficiales"},{page:"perfil",ico:"fa-user-shield",color:"#a855f7",title:"Mi Cuenta",sub:"Configuración personal"}];return`
  <div class="gs_page">
  ...
  </div>`},W=async()=>{const a=x();if(!a)return;e(document).off(".gs");const o=r("gsRealTime")===!0;o&&e("#gs_btn_rt").addClass("active"),await E(a),o&&S(a),e(document).on("click.gs","#gs_btn_rt",function(){const s=!e(this).hasClass("active");e(this).toggleClass("active",s),p("gsRealTime",s,24*365),s?S(a):(b.feedSub?.(),b.feedSub=null)}),e(document).on("click.gs","#gs_refresh",async function(){const s=e(this).find("i").addClass("fa-spin");[$,y,A,k].forEach(t=>localStorage.removeItem(t)),await E(a,!0),setTimeout(()=>s.removeClass("fa-spin"),500)}),e(document).on("click.gs",".nv_item",function(s){s.preventDefault();const t=e(this).data("page");t&&C(async()=>{const{rutas:i}=await import("./main-Dlu14CdS.js").then(l=>l.A);return{rutas:i}},__vite__mapDeps([0,1])).then(({rutas:i})=>i.navigate(`/${t}`))}),e(document).on("click.gs",".gs_fi_btn",function(){const s=e(this).data("usuario");p("gsBuscarTerm",s,1/60),C(async()=>{const{rutas:t}=await import("./main-Dlu14CdS.js").then(i=>i.A);return{rutas:t}},__vite__mapDeps([0,1])).then(({rutas:t})=>t.navigate("/buscar"))})},G=()=>{b.feedSub?.(),e(document).off(".gs")};async function E(a,o=!1){await Promise.all([j(a,o),H(a,o)])}async function j(a,o=!1){if(!o){const s=r($),t=r(y),i=r(k);if(s!=null&&e("#gs_k_alumnos").text(s),t!=null&&e("#gs_k_clases").text(t),i?.wpm&&e("#gs_k_wpm").text(i.wpm),i?.cert!=null&&e("#gs_k_cert").text(i.cert),s!=null&&t!=null&&i)return}try{let s=await m(g(f(_,"lecciones"),u("gestor_id","==",a.usuario)));s.empty&&(s=await m(g(f(_,"lecciones"),u("gestorId","==",a.usuario))));const t=s.docs.map(d=>d.data()),i=t.length,l=t.reduce((d,I)=>d+(I.wpmMax||0),0),n=i>0?Math.round(l/i):0,v=t.filter(d=>(d.completadas?.length||0)>=45&&(d.wpmMax||0)>=80).length;p($,i,2),p(k,{wpm:n,cert:v},2),e("#gs_k_alumnos").text(i),e("#gs_k_wpm").text(n||"—"),e("#gs_k_cert").text(v);let c=await m(g(f(_,"clases"),u("gestor_id","==",a.usuario)));c.empty&&(c=await m(g(f(_,"clases"),u("gestorId","==",a.usuario)))),p(y,c.size,2),e("#gs_k_clases").text(c.size)}catch(s){console.error("[gestor] Error KPIs",s)}}async function H(a,o=!1){if(!(!o&&r("gsRealTime")===!0)){if(!o){const s=r(A);if(s?.length){h(s);return}}try{let s=await m(g(f(_,"lecciones"),u("gestor_id","==",a.usuario),P("ultPractica","desc"),w(15)));s.empty&&(s=await m(g(f(_,"lecciones"),u("gestorId","==",a.usuario),P("ultPractica","desc"),w(15))));const t=s.docs.map(i=>({usuario:i.id,...i.data()}));p(A,t,1/12),h(t)}catch{try{const i=(await m(g(f(_,"lecciones"),u("gestor_id","==",a.usuario),w(15)))).docs.map(l=>({usuario:l.id,...l.data()}));h(i)}catch{h([])}}}}function S(a){b.feedSub?.();const o=g(f(_,"lecciones"),u("gestor_id","==",a.usuario),w(15));b.feedSub=V(o,s=>{const t=s.docs.map(i=>({usuario:i.id,...i.data()}));t.sort((i,l)=>{const n=i.ultPractica?.toDate?i.ultPractica.toDate().getTime():0;return(l.ultPractica?.toDate?l.ultPractica.toDate().getTime():0)-n}),h(t)})}function h(a){if(e("#gs_feed_num").text(a.length>0?`${a.length} Registros`:"0 Registros"),!a.length){e("#gs_feed").html(`
      <div class="gs_feed_empty">
        <i class="fas fa-ghost"></i>
        <p>No hay actividad registrada aún.<br><small>Tus alumnos aparecerán aquí al iniciar una lección.</small></p>
      </div>`);return}const o=a.map(s=>{const t=T(s.nombre||s.usuario||"A"),i=s.wpmMax||0,l=s.precision||0,n=s.completadas?.length||0,v=Math.round(n/45*100),c=s.clase_id||s.claseId||null,d=s.ultPractica?.toDate?O(s.ultPractica):"Reciente";return`
      <div class="gs_fi">
