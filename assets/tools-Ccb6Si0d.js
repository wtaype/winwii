import{j as a}from"./vendor-gzd0YkcT.js";import{a as F,N as p,i as T}from"./main-B7BjZQg_.js";const S=(()=>{if(typeof window>"u")return"";const l=window.location.hostname;return new Set(["localhost",T]).has(l)?`http://${l}:3000`:window.location.origin})(),O=()=>`
