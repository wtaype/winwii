import{j as i}from"./vendor-gzd0YkcT.js";import{auth as y,db as u}from"./firebase-B2ji0hhV.js";import{m as I,c as h,k as A,d as b,q as L,w as T,a as S,e as f}from"./firebase-DYzFYKGm.js";import{N as n,h as l,g as U,d as p}from"./main-DGj1lpKw.js";const e="wiAudios",d="wiImg",m=()=>U("wiSmile")?.email||y.currentUser?.email||"",g=async s=>{const t=m();if(!t)return[];const r=L(h(u,s),T("email","==",t));return(await S(r)).docs.map(c=>({id:c.id,...c.data()})).sort((c,o)=>(o.creado?.seconds||0)-(c.creado?.seconds||0))},v=async(s,t,r)=>{const a=m();return a?(await I(h(u,s),{email:a,titulo:t,src:r,creado:f(),actualizado:f()})).id:null},k=async(s,t)=>{await A(b(u,s,t))},B=()=>g(e),D=()=>g(d),x=(s,t)=>`
