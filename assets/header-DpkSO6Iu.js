const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/login-qTpmDdei.js","assets/vendor-gzd0YkcT.js","assets/firebase-DidwnjmV.js","assets/main-7L2fqyIW.js","assets/firebase-D8KAgKJW.js","assets/login-pzxUIRzl.css"])))=>i.map(i=>d[i]);
import{M as c,e as n,r as l,_ as e}from"./main-7L2fqyIW.js";import{j as s}from"./vendor-gzd0YkcT.js";const r=a=>{c?.("Bienvenido "+a.nombre),s(".nv_right").html(`
  ...
  `)};n.on(a=>a?r(a):(o(),l.navigate("/")));const i=n.user;i?r(i):o();const p=["wiTema","wiSmart","wiFresh"];s(document).on("click",".bt_salir",async()=>{const{salir:a}=await e(async()=>{const{salir:t}=await import("./login-qTpmDdei.js");return{salir:t}},__vite__mapDeps([0,1,2,3,4,5]));a(p)});s(document).on("click",".bt_auth",async function(){const{abrirLogin:a}=await e(async()=>{const{abrirLogin:t}=await import("./login-qTpmDdei.js");return{abrirLogin:t}},__vite__mapDeps([0,1,2,3,4,5]));a(s(this).hasClass("registrar")?"registrar":"login")});export{r as personal};
