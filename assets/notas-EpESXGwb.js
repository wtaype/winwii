import{j as s}from"./vendor-gzd0YkcT.js";import{auth as k,db as m}from"./firebase-a1Ov4hWR.js";import{s as C,d as p,b,a as I,q as F,c as O,w as j,m as L,g as A}from"./firebase-Whrs9NU2.js";import{r as q,a as B,S as P,d as f,g as U,N as w}from"./main-ChOd9MzQ.js";let o=[],u=null,g=null,h=null;const $="wi_notas_cache",E="wi_notas_cache_time",H=100,M=1200,V=300*1e3,x=()=>U("wiSmile")||{},l=n=>{try{localStorage.setItem($,JSON.stringify(n)),localStorage.setItem(E,Date.now().toString())}catch{}},N=()=>{try{return JSON.parse(localStorage.getItem($)||"[]")}catch{return[]}},G=()=>{const n=parseInt(localStorage.getItem(E)||"0");return Date.now()-n<V},R=()=>{localStorage.removeItem($),localStorage.removeItem(E)},y=[{id:"Cielo",hex:"#0EBEFF",bg:"rgba(14,190,255,.12)",tx:"var(--tx)"},{id:"Rosa",hex:"#FF5C93",bg:"rgba(255,92,147,.12)",tx:"var(--tx)"},{id:"Verde",hex:"#10B981",bg:"rgba(16,185,129,.12)",tx:"var(--tx)"},{id:"Morado",hex:"#8B5CF6",bg:"rgba(139,92,246,.12)",tx:"var(--tx)"},{id:"Naranja",hex:"#F59E0B",bg:"rgba(245,158,11,.12)",tx:"var(--tx)"}],ra=()=>{const n=x();if(!n.email)return location.replace("/"),"";const a=n.nombre||n.usuario||n.email||k.currentUser?.email||"";return`
